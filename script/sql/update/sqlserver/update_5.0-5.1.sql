ALTER TABLE gen_table
    ADD data_name nvarchar(200) DEFAULT '' NULL GO
...
VALUES (30, N'000000', 0, N'密码认证', N'password', N'sys_grant_type', N'', N'default', N'N', N'0', 103, 1, getdate(), NULL, NULL, N'密码认证');
GO
...
ALTER TABLE sys_dept
    ALTER COLUMN leader BIGINT NULL
    GO
